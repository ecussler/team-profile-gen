...
function renderManager(manager) {
    ...
    <h5 class="card-title" id="manager-name">${manager.managerName}</h5>
    <h6 class="card-subtitle mb-2 text-muted" id="manager-title">Manager</h6>
    <p class="card-text" id="manager-ID">ID: ${manager.managerID}</p>
    <p class="card-text" id="manager-email">Email: <a href="mailto:${manager.managerEmail}">${manager.managerEmail}</a></p>
    <p class="card-text" id="manager-office">Office Number: ${manager.managerOffice}</p>
</div>`
}
